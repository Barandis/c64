...
export function newIoCircuit({ U1, U2, U7, U8, U18, U19, U28 }, { CN1, CN2, CN3, CN4, CN8, CN9 }) {
  ...
  // here.
  const COL0 = newTrace(PULL_UP, U1.PA0, CN1.COL0, CN8.JOYB0)
  const COL1 = newTrace(PULL_UP, U1.PA1, CN1.COL1, CN8.JOYB1)
  const COL2 = newTrace(PULL_UP, U1.PA2, CN1.COL2, CN8.JOYB2)
  const COL3 = newTrace(PULL_UP, U1.PA3, CN1.COL3, CN8.JOYB3)
  const COL4 = newTrace(PULL_UP, U1.PA4, CN1.COL4, CN8.BTNB)
  const COL5 = newTrace(PULL_UP, U1.PA5, CN1.COL5)
  const COL6 = newTrace(PULL_UP, U1.PA6, CN1.COL6, U28.A3, U28.A4)
  const COL7 = newTrace(PULL_UP, U1.PA7, CN1.COL7, U28.A1, U28.A2)
  const ROW0 = newTrace(PULL_UP, U1.PB0, CN1.ROW0, CN9.JOYA0)
  const ROW1 = newTrace(PULL_UP, U1.PB1, CN1.ROW1, CN9.JOYA1)
  const ROW2 = newTrace(PULL_UP, U1.PB2, CN1.ROW2, CN9.JOYA2)
  const ROW3 = newTrace(PULL_UP, U1.PB3, CN1.ROW3, CN9.JOYA3)
  const ROW4 = newTrace(PULL_UP, U1.PB4, CN1.ROW4, CN9.BTNA_LP, U19.LP)
  const ROW5 = newTrace(PULL_UP, U1.PB5, CN1.ROW5)
  const ROW6 = newTrace(PULL_UP, U1.PB6, CN1.ROW6)
  const ROW7 = newTrace(PULL_UP, U1.PB7, CN1.ROW7)
  ...
  const PA2 = newTrace(PULL_UP, U2.PA2, CN2.PA2)
  const PB0 = newTrace(PULL_UP, U2.PB0, CN2.PB0)
  const PB1 = newTrace(PULL_UP, U2.PB1, CN2.PB1)
  const PB2 = newTrace(PULL_UP, U2.PB2, CN2.PB2)
  const PB3 = newTrace(PULL_UP, U2.PB3, CN2.PB3)
  const PB4 = newTrace(PULL_UP, U2.PB4, CN2.PB4)
  ...
  const SP1 = newTrace(PULL_UP, U1.SP, CN2.SP1)
  const CNT1 = newTrace(PULL_UP, U1.CNT, CN2.CNT1)
  const ATNOUT = newTrace(U2.PA3, U8.A1)
  const CLKOUT = newTrace(U2.PA4, U8.A4)
  const DATAOUT = newTrace(U2.PA5, U8.A2)
  const ATN = newTrace(PULL_UP, U8.Y1, CN2.ATN, CN4.ATN)
  const CLK = newTrace(PULL_UP, U8.Y4, U2.PA6, CN4.CLK)
  const DATA = newTrace(PULL_UP, U8.Y2, U2.PA7, CN4.DATA)
  const _SRQ = newTrace(PULL_UP, U1._FLAG, CN4._SRQ)
  ...
  const SENSE = newTrace(PULL_UP, U7.P4, CN3.SENSE)
