...
export default class Ic6567 extends Chip {
  constructor() {
    super(
      ...
      // therefore is controlled by the _CS, AEC, and R__W pins.
      ...
      // Clock signal pins. Two clocks are inputs - the color clock (φcolor) at 14.31818 MHz
      // and the dot clock (φin) at 8.18 MHz - and the latter is divided by 8 to create the
      // system clock (φ0) output that drives the CPU.
      ...
      // than it normally has with the φ2 low cycle. After three clock cycles, the AEC pin
      ...
      // reading and writing of its registers. This pin has no effect during the φ2 low
      ...
      // while a low indicates they are to be written. Has no effect during the φ2 low
      // cycle.
