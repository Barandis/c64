...
export default function Ic6567() {
  const chip = Chip(
    ...
    new Pin(18, 'RAS', OUTPUT).set(),
    new Pin(19, 'CAS', OUTPUT).set(),
    ...
    new Pin(21, 'PHICOLOR', INPUT),
    new Pin(22, 'PHIIN', INPUT),
    new Pin(17, 'PHI0', OUTPUT),
