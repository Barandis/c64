...
export function Ic4066() {
  const chip = Chip(
    ...
    Pin(1, "X1", BIDIRECTIONAL),
    Pin(2, "Y1", BIDIRECTIONAL),
    Pin(13, "A1", INPUT),

    // I/O and control pins for switch 2
    Pin(3, "X2", BIDIRECTIONAL),
    Pin(4, "Y2", BIDIRECTIONAL),
    Pin(5, "A2", INPUT),

    // I/O and control pins for switch 3
    Pin(9, "X3", BIDIRECTIONAL),
    Pin(8, "Y3", BIDIRECTIONAL),
    Pin(6, "A3", INPUT),

    // I/O and control pins for switch 4
    Pin(11, "X4", BIDIRECTIONAL),
    Pin(10, "Y4", BIDIRECTIONAL),
    Pin(12, "A4", INPUT),
