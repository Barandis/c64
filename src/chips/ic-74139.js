 ...
 * enable pin starting with `_G`, and four inverted outputs whose names start with `_Y`.
 *
 ...
 * `A8`-`A11`, and the enable pin of demux 1 comes directly from the PLA's `_IO` output.
 * Thus the demultiplexers only do work when `_IO` is selected, which requires that the
 * address be from 0xD000 - 0xDFFF, among other things. A more specific table for this setup
 * can thus be created.
 *
 ...
 * decoding when the PLA's `_IO` output is selected.
 *
 * This chip is produced by calling the `{@link module:chips.Ic74139|Ic74139}` function.
 *
 * @typedef Ic74139
 * @property {Pin} _G1 [1] The active-low enable pin for demultiplexer 1.
 * @property {Pin} A1 [2] The first input to demultiplexer 1.
 * @property {Pin} B1 [3] The second input to demultiplexer 1.
 * @property {Pin} _Y10 [4] The first inverted output from demultiplexer 1.
 * @property {Pin} _Y11 [5] The second inverted output from demultiplexer 1.
 * @property {Pin} _Y12 [6] The third inverted output from demultiplexer 1.
 * @property {Pin} _Y13 [7] The fourth inverted output from demultiplexer 1.
 * @property {Pin} _G2 [15] The active-low enable pin for demultiplexer 2.
 * @property {Pin} A2 [14] The first input to demultiplexer 2.
 * @property {Pin} B2 [13] The second input to demultiplexer 2.
 * @property {Pin} _Y20 [12] The first inverted output from demultiplexer 2.
 * @property {Pin} _Y21 [11] The second inverted output from demultiplexer 2.
 * @property {Pin} _Y22 [10] The third inverted output from demultiplexer 2.
 * @property {Pin} _Y23 [9] The fourth inverted output from demultiplexer 2.
