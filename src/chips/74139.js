...
export function create74139() {
  ...
  const pins = createPinArray(
    ...
    createPin(4, "_Y10", OUTPUT, false),
    createPin(5, "_Y11", OUTPUT, true),
    createPin(6, "_Y12", OUTPUT, true),
    createPin(7, "_Y13", OUTPUT, true),
    createPin(1, "_G1", INPUT),

    // Demultiplexer 2
    createPin(14, "A2", INPUT),
    createPin(13, "B2", INPUT),
    createPin(12, "_Y20", OUTPUT, false),
    createPin(11, "_Y21", OUTPUT, true),
    createPin(10, "_Y22", OUTPUT, true),
    createPin(9, "_Y23", OUTPUT, true),
