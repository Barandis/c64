...
export function create74139() {
  ...
  const pins = {
    ...
    _Y10: createPin(4, "_Y10", OUTPUT, false),
    _Y11: createPin(5, "_Y11", OUTPUT, true),
    _Y12: createPin(6, "_Y12", OUTPUT, true),
    _Y13: createPin(7, "_Y13", OUTPUT, true),
    _G1: createPin(1, "_G1", INPUT),

    // Demultiplexer 2
    A2: createPin(14, "A2", INPUT),
    B2: createPin(13, "B2", INPUT),
    _Y20: createPin(12, "_Y20", OUTPUT, false),
    _Y21: createPin(11, "_Y21", OUTPUT, true),
    _Y22: createPin(10, "_Y22", OUTPUT, true),
    _Y23: createPin(9, "_Y23", OUTPUT, true),
