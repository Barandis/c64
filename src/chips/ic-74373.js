 ...
 *
 * The chip has an active-low output enable pin, `_OE`. When this is high, all outputs are
 ...
 * main bus.
 *
 * This chip is produced by calling the `{@link module:chips.Ic74373|Ic74373}` function.
 *
 * @typedef Ic74373
 * @property {Pin} _OE [1] The chip-wide active-low output enable pin. When this pin is
 *     high, all of the `Q` pins are put into a high impedance state, disconnecting them
 *     from their circuits.
 * @property {Pin} LE [11] The latch enable. As long as this pin is high, data will flow
 *     from input to output pins freely. Setting `LE` to low will latch the output pins,
 *     keeping them constant no matter the levels on the input pins.
 ...
 * @property {Pin} Vcc [20] The positive power supply. This pin is not emulated.
